  ...
  return (
    <TooltipProvider delayDuration={150}>
      ...
      >
        ...
        {/* Scrollable agents list. The Claim button below is a normal
            flex sibling — the scroll area terminates exactly at the
            button's top edge, so the button itself acts as the visual
            stop instead of a separator line or fade gradient. */}
        <div
          className={cn(
