      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            read-only view of the agent&apos;s conversations and the
            ability to pause or release it. The key is used to look up
            the agent and is not stored on the dashboard.
          </DialogDescription>
        </DialogHeader>
